...
use crate::commands::{
    append::Append, auth::Auth, blpop::BLPop, brpop::BRPop, bzpopmax::BZPopMax, bzpopmin::BZPopMin,
    client::Client, command::CommandInfo, config::Config, dbsize::DbSize, decr::Decr,
    decrby::DecrBy, echo::Echo, getdel::GetDel, getrange::GetRange, getset::GetSet, hdel::HDel,
    hello::Hello, hexists::HExists, hget::HGet, hgetall::HGetAll, hincrby::HIncrBy,
    hincrbyfloat::HIncrByFloat, hkeys::HKeys, hlen::HLen, hmget::HMGet, hrandfield::HRandField,
    hscan::HScan, hset::HSet, hsetnx::HSetNx, hvals::HVals, incr::Incr, incrby::IncrBy,
    incrbyfloat::IncrByFloat, info::Info, keys::Keys, lindex::LIndex, linsert::LInsert, llen::LLen,
    lpop::LPop, lpush::LPush, lpushx::LPushX, lrange::LRange, lrem::LRem, lset::LSet, ltrim::LTrim,
    mget::MGet, mset::MSet, msetnx::MSetNx, ping::Ping, quit::Quit, rpop::RPop, rpush::RPush,
    rpushx::RPushX, sadd::SAdd, scan::Scan, scard::SCard, sdiff::SDiff, sdiffstore::SDiffStore,
    select::Select, setrange::SetRange, sinter::SInter, sinterstore::SInterStore,
    sismember::SIsMember, smembers::SMembers, smismember::SMIsMember, smove::SMove, spop::SPop,
    srandmember::SRandMember, srem::SRem, sscan::SScan, strlen::StrLen, sunion::SUnion,
    sunionstore::SUnionStore, time::Time, type_cmd::Type as TypeCommand, zadd::ZAdd, zcard::ZCard,
    zcount::ZCount, zdiffstore::ZDiffStore, zincrby::ZIncrBy, zinterstore::ZInterStore,
    zlexcount::ZLexCount, zmscore::ZMScore, zpopmax::ZPopMax, zpopmin::ZPopMin, zrange::ZRange,
...
pub(super) fn route_key_for_name<'a>(name: &str, first: Option<&'a [u8]>) -> Option<&'a [u8]> {
    match name {
        ...
        | "CLIENT" | "DBSIZE" | "TIME" | "INFO" | "SCAN" | "RANDOMKEY" => None,
        _ => first,
    }
}
