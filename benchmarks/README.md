...
| Redis Cluster direct routing vs shardcache direct routing | [`REDIS_CLUSTER_SCALABILITY_BENCHMARKS.md`](REDIS_CLUSTER_SCALABILITY_BENCHMARKS.md) | Adam Redis Cluster vs shardcache SCNP direct-routing GET/SET sweep with isolated small, 1 KiB, 4 KiB, 16 KiB, 64 KiB, and 256 KiB value-size suites | Publishable for the saved 16-vCPU value-size run; rerun the same suites for new hardware or a full 1,2,4,8,16 vCPU matrix. |
