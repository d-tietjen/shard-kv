# shardmap Memory Bandwidth Ceiling
...
The goal is to show how much of the machine's bandwidth shardmap can expose.
...
| Pool length | `8` |
| Threads | `1` |
| CSV artifact | `/tmp/shardmap-memory-write/benchmarks/results/memory_write_cost_20260518_000025/memory_write_cost.csv` |
...
- Hardware ceilings should be recorded alongside large-value shardmap runs.
  The shardmap product claim is hardware-scaled bandwidth exposure, not one
