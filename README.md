...
| 0.8 feature guide | [`docs/RELEASE_0_8.md`](docs/RELEASE_0_8.md) | You want the vector, replication, and active-active feature catalog, deployment contract, release boundaries, and links to the full protocol design. |
