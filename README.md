...
| 0.7 active-active replication | [`docs/ACTIVE_ACTIVE_REPLICATION.md`](docs/ACTIVE_ACTIVE_REPLICATION.md) | You want feature-gated, eventually consistent point-value sync, causal conflict handling, optional Blossom conflict ordering, independent local eviction, snapshots, mTLS peer exchange, and revisioned membership reconciliation. |
